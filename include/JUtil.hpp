...
static const char* const kSchemaPath = "@WEBOS_INSTALL_WEBOS_SYSCONFDIR@/schemas/notificationmgr/";
...
public:
     ...
     * Schema path is set to "/etc/palm/schemas/notification/" + schemaName + ".schema"
